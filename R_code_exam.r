...
# Sito utilizzato per scaricare le immagini: https://earthexplorer.usgs.gov/
# Luogo di studio: Papua pronvincia dell'Indonesia 
# Satellite Landsat path 100 row 65 - anno 2020 - anno 1990 
...
# importiamo la singola immagine del 1990 
...
papua1990B1 <- raster("LT05_L2SP_100065_19901120_20200915_02_T1_SR_B1.TIF")
# funzione plot: visualizzo il file
plot(papua1990B1)
# leggo le informazioni di papua1990B1
papua1990B1
# class      : RasterLayer 
# dimensions : 6941, 7761, 53869101  (nrow, ncol, ncell)
# resolution : 30, 30  (x, y)
# extent     : 363285, 596115, -901215, -692985  (xmin, xmax, ymin, ymax)
# crs        : +proj=utm +zone=54 +datum=WGS84 +units=m +no_defs 
# source     : C:/esame_telerilevamento_2021/LT05_L2SP_100065_19901120_20200915_02_T1_SR_B1.TIF 
# names      : LT05_L2SP_100065_19901120_20200915_02_T1_SR_B1 
# values     : 0, 65535  (min, max)

# Ho 5 immagini che sono 5 Raster Layer ovvero 5 singoli strati, voglio compattare tutti i layer in un unico file Raster Stack 
# funzione list.files: crea una lista di file e questi li riconosce perchè nel nome c'è un pattern che si ripete ovvero: "LT05"
lista <- list.files(pattern="LT05")
# funzione lapply: applica una funzione a tutta la lista appena creata (in questo caso raster perchè voglio importati i vari layer) 
importa <- lapply(lista, raster)
# funzione stack: raggruppa i file importati precedentemente (a cui è stata applicata la funzione raster) in un unico blocco di file 
papua1990 <- stack(importa) 

# visualizzo le informazioni di papua1990
papua1990
# class      : RasterStack 
# dimensions : 6941, 7761, 53869101, 5  (nrow, ncol, ncell, nlayers)
# resolution : 30, 30  (x, y)
# extent     : 363285, 596115, -901215, -692985  (xmin, xmax, ymin, ymax)
# crs        : +proj=utm +zone=54 +datum=WGS84 +units=m +no_defs 
# names      : LT05_L2SP_100065_19901120_20200915_02_T1_SR_B1, LT05_L2SP_100065_19901120_20200915_02_T1_SR_B2, LT05_L2SP_100065_19901120_20200915_02_T1_SR_B3, LT05_L2SP_100065_19901120_20200915_02_T1_SR_B4, LT05_L2SP_100065_19901120_20200915_02_T1_SR_B5 
# min values :                                              0,                                              0,                                              0,                                              0,                                              0 
# max values :                                          65535,                                          65535,                                          65535,                                          65535,                                          65535 

# visualizzo le 5 bande del file papua1990
plot(papua1990)
